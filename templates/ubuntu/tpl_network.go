...
var ubuntucreatenetworkopennebula *UbuntuCreateNetworkOpennebula

func init() {
	ubuntucreatenetworkopennebula = &UbuntuCreateNetworkOpennebula{}
	templates.Register("UbuntuCreateNetworkOpennebula", ubuntucreatenetworkopennebula)
}

type UbuntuCreateNetworkOpennebula struct {
	bridge      string
  iptype       string
	ip      string
  size    string
...
func (tpl *UbuntuCreateNetworkOpennebula) Options(t *templates.Template) {
...
func (tpl *UbuntuCreateNetworkOpennebula) Render(p urknall.Package) {
	p.AddTemplate("createnetworkopennebula", &UbuntuCreateNetworkOpennebulaTemplate{
		bridge:     tpl.bridge,
    iptype:    tpl.iptype,
		ip:   tpl.ip,
    size: tpl.size,
...
func (tpl *UbuntuCreateNetworkOpennebula) Run(target urknall.Target) error {
...
type UbuntuCreateNetworkOpennebulaTemplate struct {
  bridge     string
  iptype    string
	ip   string
  size string
...
func (m *UbuntuCreateNetworkOpennebulaTemplate) Render(pkg urknall.Package) {
